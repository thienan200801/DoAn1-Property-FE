...
export const getServerSideProps = async () => {
  ...
  try {
    const { status, data } = await PostServices.getPosts("NEWS");
...
export default function NewsPost({ posts }) {
  const { t } = useTranslation();

  return (
    <div className="flex-1">
      <NextSeo title={t("common:tin-tuc")} description={t("common:tin-tuc")} />
      <div>
        <PageHeading content={t("common:tin-tuc")} />
